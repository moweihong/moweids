...
require_once BASE_PATH.'/api/payment/chinapay/lib/log.class.php';
require_once BASE_PATH.'/api/payment/chinapay/lib/SDKConfig.php';
require_once BASE_PATH.'/api/payment/chinapay/lib/secureUtil.php';
