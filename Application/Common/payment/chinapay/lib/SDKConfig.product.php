...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/data001/www/site/allwood-com/shop/api/payment/chinapay/cert/898440353113449.pfx';
...
const SDK_VERIFY_CERT_DIR = '/data001/www/site/allwood-com/shop/api/payment/chinapay/cert/';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://p.allwood.com.cn/shop/api/payment/chinapay/return_url.php';

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
const SDK_BACK_NOTIFY_URL = 'http://p.allwood.com.cn/shop/api/payment/chinapay/notify_url.php';

//文件下载目录 
const SDK_FILE_DOWN_PATH = '/data001/www/site/allwood-com/shop/api/payment/chinapay/file/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/data001/www/site/allwood-com/data/log/chinapay/';
