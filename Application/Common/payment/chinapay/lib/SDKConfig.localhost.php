...
// 签名证书路径
const SDK_SIGN_CERT_PATH = 'E:\www\www.allwood.com\shop\api\payment/chinapay/cert/acp_test_sign.pfx';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://allwood.dev/shop/api/payment/chinapay/return_url.php';

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
const SDK_BACK_NOTIFY_URL = 'http://p.allwood.com.cn/shop/api/payment/chinapay/notify_url.php';

//文件下载目录 
const SDK_FILE_DOWN_PATH = 'E:\www\www.allwood.com\data/log/chinapay/file/';

//日志 目录 
const SDK_LOG_FILE_PATH = 'E:\www\www.allwood.com\data/log/chinapay/';
