		...
		if(!empty($code_list) && is_array($code_list)) {
    		...
    		switch ($web_id) {
        	    ...
        	    case 121:
        	    	...
        	    	break;
	    case 122:
        	    	$style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'ycl.php';
        	    	break;
	    case 123:
        	    	$style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'gyp.php';
        	    	break;
	    case 124:
        	    	$style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'cp.php';
        	    	break;
  	   case 125:
        	    	$style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'pp.php';
        	    	break;
  	   case 126:
        	    	$style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'jp.php';
        	    	break;
  	   case 127:
        	    	$style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'mqfq.php';
        	    	break;
  	   case 128:
        	    	$style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'ppzq.php';
        	    	break;
  	   case 129:
        	    	$style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'zxsj.php';
        	    	break;
  	   case 130:
        	    	$style_file = BASE_DATA_PATH.DS.'resource'.DS.'web_config'.DS.'zxcl.php';
        	    	break;
        	    default:
