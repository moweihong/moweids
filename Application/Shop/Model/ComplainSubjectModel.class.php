...
use Think\Model;
class ComplainSubjectModel extends Model{
	...
	public function getActiveComplainSubject($condition='',$page='') {
        ...
        $param['where'] =" complain_subject_state = '1' AND new_version= 0 ";
        $param['order'] = $condition['order'] ? $condition['order']: ' complain_subject_id desc ';
        return Db::select($param,$page) ;
     ...
     *  @return array
     */
    public function getActiveNewComplainSubject($condition='',$page='') {

        //搜索条件
        $condition['complain_subject_state'] = 1;
        $condition['new_version'] = 0;
        $param['table'] = 'complain_subject' ;
        $param['where'] = " complain_subject_state = '1' AND new_version=1 ";
        $param['order'] = $condition['order'] ? $condition['order']: ' complain_subject_id desc ';
        return Db::select($param,$page) ;
