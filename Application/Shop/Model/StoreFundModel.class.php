...
class StoreFundModel extends Model {
    ...
    public function getPdRechargeList($condition = array(), $pagesize = '', $fields = '*', $order = '', $limit = '') {
        return $this->table('store_fund')->where($condition)->field($fields)->order($order)->limit($limit)->page($pagesize)->select();
    }
    ...
    public function addPdRecharge($data) {
        return $this->table('store_fund')->insert($data);
    }
    ...
    public function editPdRecharge($data,$condition = array()) {
        return $this->table('store_fund')->where($condition)->update($data);
    }
    ...
    public function getPdRechargeInfo($condition = array(), $fields = '*') {
        return $this->table('store_fund')->where($condition)->field($fields)->find();
    }
    ...
    public function getPdRechargeCount($condition = array()) {
        return $this->table('store_fund')->where($condition)->count();
    }
    ...
    public function delPdRecharge($condition) {
        return $this->table('store_fund')->where($condition)->delete();
    }
