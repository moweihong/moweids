$(function(){
	...
	TransTpl += "<div class=\"default J_DefaultSet\" style=\"background:#E8F2FF\">\n";
	TransTpl += "默认运费：\n";
	TransTpl += "<input class=\"w50 mr5 text \" type=\"text\" aria-label=\"默认运费件数\" maxlength=\"4\" autocomplete=\"off\" data-field=\"start\" value=\"1\" name=\"default[TRANSTYPE][start]\">\n";
	TransTpl += "<span class=\"tiji\" id='trans1'>件内，</span>\n";
	TransTpl += "<input class=\"w50 text\" type=\"text\" aria-label=\"默认运费价格\" maxlength=\"6\" autocomplete=\"off\" value=\"0.00\" name=\"default[TRANSTYPE][postage]\" data-field=\"postage\">";
	TransTpl += "<em class=\"add-on ml5\">";
	TransTpl += "元";
	TransTpl += "<\/em>， 每增加\n";
	TransTpl += "<input class=\"w50 ml5 mr5 text\" type=\"text\" aria-label=\"每加件\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"plus\" name=\"default[TRANSTYPE][plus]\">\n";
	TransTpl += "<span class=\"tiji\" id='trans2'>件</span>， 增加运费\n";
	TransTpl += "<input class=\"w50 ml5 text\" type=\"text\" aria-label=\"加件运费\" maxlength=\"6\" autocomplete=\"off\" value=\"0.00\" data-field=\"postageplus\" name=\"default[TRANSTYPE][postageplus]\">";
	TransTpl += "<em class=\"add-on ml5\">";
	TransTpl += "元";
	TransTpl += "<\/em>\n";
	...
	SpecialMessage = '';
	SpecialMessage += "<span  error_type=\"area\" class=\"msg J_Message\" style=\"display:none\"><i class=\"icon-exclamation-sign\"><\/i>请确认地址是否填写~<\/span>\n";
	...
	RuleHead += "<tr>\n";
	RuleHead += "<th>运送到<\/th>\n";
	RuleHead += "<th class=\"w110\"><span class=\"shoutiji\">首件(件)</span><\/th>\n";
	RuleHead += "<th class=\"w80\">首费(元)<\/th>\n";
	RuleHead += "<th class=\"w110\"><span class=\"xutiji\">续件(件)<\/th>\n";
	RuleHead += "<th class=\"w80\">续费(元)<\/th>\n";
...
//	RuleCell += "<a class=\"ncu-btn2\" title=\"编辑运送区域\" area-haspopup=\"true\" area-controls=\"J_DialogArea\" entype=\'J_EditArea\' data-acc=\"event:enter\" href=\"JavaScript:void(0);\">编辑<\/a>\n";
	...
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w50\" type=\"text\" aria-label=\"首件\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"start\" name=\"special[TRANSTYPE][CurNum][start]\">\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w50\" type=\"text\" aria-label=\"首费\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postage\" name=\"special[TRANSTYPE][CurNum][postage]\"><em class=\"add-on\">\n";
	RuleCell += "\n";
	RuleCell += "<\/em>\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w50\" type=\"text\" aria-label=\"续件\" maxlength=\"4\" autocomplete=\"off\" value=\"1\" data-field=\"plus\" name=\"special[TRANSTYPE][CurNum][plus]\">\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td>\n";
	RuleCell += "<input class=\"text w50\" type=\"text\" aria-label=\"续费\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postageplus\" name=\"special[TRANSTYPE][CurNum][postageplus]\"><em class=\"add-on\">\n";
	RuleCell += "\n";
	RuleCell += "<\/em>\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<td class=\"nscs-table-handle\">\n";
	RuleCell += "<span>\n";
	RuleCell += "<a class=\"cor-blue J_DeleteRule\" ncNum=\"nCurNum\" href=\"JavaScript:void(0);\">\n";
	RuleCell += "<p>删除<\/p>\n";
	RuleCell += "<\/a>\n";
	RuleCell += "<\/span>\n";
	RuleCell += "<span>\n";
	RuleCell += "<a class=\"cor-blue ml5\" data-group=\"nCurNum\" title=\"编辑运送区域\" area-haspopup=\"true\" area-controls=\"J_DialogArea\" entype=\'J_EditArea\' data-acc=\"event:enter\" href=\"JavaScript:void(0);\">\n";
	RuleCell += "<p>编辑<\/p>\n";
	RuleCell += "<\/a>\n";	
	RuleCell += "<\/span>\n";
	RuleCell += "<\/td>\n";
...
//	                if(target.getAttribute("id")==$(objPanel).attr('id'))return true;
	...
	/*	选择运送区域*/
	$('.js-express .trans-line').on('click','a[entype="J_EditArea"]',function () {
	...
	/*	选择运送区域*/
	$('.js-logistics .trans-line').on('click','a[entype="J_EditArea"]',function () {
		//curTransType = $(this).next().next().attr('name').substring(6,8);
		curTransType = 'wl';
		//取消所有已选择的checkbox
		$('#J_CityList').find('input[type="checkbox"]').attr('checked',false).attr('disabled',false);
