...
(function(root, factory) {
	...
	Paging.prototype = {
		...
		bindToolbar: function() {
			var _this = this;
			var html = $('<li class="ui-paging-toolbar"><span class="js-page-total">共 <b>'+this.pagecount+'</b> 页</span><select class="ui-select-pagesize"></select><span class="ml10">到第</span><input type="text" class="text ui-paging-count" /> 页 <a href="javascript:void(0)">跳转</a></li>');
