...
alter table allwood_goods modify column is_offline int(11) DEFAULT 0 COMMENT '商品类型 0 经销商发布的商品 1 平板发布的商品 2 工厂发布的商品';
alter table allwood_goods_common modify column is_offline int(11) DEFAULT 0 COMMENT '商品类型 0 经销商发布的商品 1 平板发布的商品 2 工厂发布的商品';

#author:鲁仕鑫
#desc:兼容询价模式，订单状态增加 1 待定价 
alter table allwood_order modify column `order_state` enum('0','1','10','20','30','40','50') DEFAULT NULL COMMENT '订单状态：0(已取消) 1 待定价 10(默认):未付款;20:已付款;30:已发货;40:已收货;50卖家处理中（分期购专用状态）';
