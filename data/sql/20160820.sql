...
#author:莫伟洪
#desc:拓展品牌表
ALTER TABLE allwood_brand ADD COLUMN `brand_desc` VARCHAR(1024) DEFAULT NULL COMMENT '品牌介绍';
ALTER TABLE allwood_brand ADD COLUMN  `brand_shoppic` VARCHAR(100) DEFAULT NULL COMMENT ' 商品图片';
ALTER TABLE allwood_brand ADD COLUMN `brand_zhaopinpic` VARCHAR(100) DEFAULT NULL COMMENT '首页招聘图片';
ALTER TABLE allwood_brand ADD COLUMN `attr_id` INT(11) DEFAULT '0' COMMENT '风格id';