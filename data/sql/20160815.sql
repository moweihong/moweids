...
##---------------------------------------------------------------------
#author:鲁仕鑫
#desc：分期购记录表，字段 add_areainfo 从int(11) 变更为  varchar(255)
alter table allwood_easypay_application modify column add_areainfo VARCHAR (255);

#author:鲁仕鑫
#desc:修改goods_common 中is_offline默认值为０
ALTER TABLE allwood_goods_common MODIFY COLUMN is_offline INT(11) DEFAULT 0;

#author:王超洪
#desc  装修添加方案添加贴息字段
ALTER TABLE allwood_order
ADD COLUMN  `xj_order_state` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0：询价中 1：已报价';
