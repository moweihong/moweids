...
#author:王超洪
#desc:装修公司效果图风格
CREATE TABLE `allwood_decorate_effectdraw_list` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `com_id` int(11) unsigned DEFAULT NULL COMMENT 'decorate_company表de_com_id',
  `store_id` int(11) unsigned DEFAULT NULL COMMENT '商店id',
  `title` varchar(50) DEFAULT NULL COMMENT '标题',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

#author:鲁仕鑫
#desc:store表和store_joinin 表中增加字段标明公司类型（家居经销商，装修公司），企业类型（个体，企业)，store表中增加保证金字段
ALTER TABLE allwood_store_joinin ADD COLUMN  `com_type` enum('1','2') DEFAULT '1' COMMENT '公司类型 1 家具经销商，2 装修公司';
ALTER TABLE allwood_store_joinin ADD COLUMN  `business_type` enum('1','2') DEFAULT '1' COMMENT '企业类型 1 企业，2 个体';

ALTER TABLE allwood_store ADD COLUMN  `com_type` enum('1','2') DEFAULT '1' COMMENT '公司类型 1 家具经销商，2 装修公司';
ALTER TABLE allwood_store ADD COLUMN  `business_type` enum('1','2') DEFAULT '1' COMMENT '企业类型 1 企业，2 个体';

ALTER TABLE allwood_store ADD COLUMN  `baozhengjin` decimal(11,3) DEFAULT '0' COMMENT '保证金金额';